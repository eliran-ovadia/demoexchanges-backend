...
from src.exchange.schemas.schemas import (
    AfterOrder, TokenData, Order, Pagination, Stock,
    PortfolioResponse, HistoryResponse, WatchlistResponse, MessageResponse,
)
...
@router.post('/watchlist', response_model=MessageResponse, status_code=status.HTTP_200_OK)
...
@router.delete('/watchlist', response_model=MessageResponse, status_code=status.HTTP_200_OK)
@limiter.limit("20/minute")
...
@router.get('/watchlist', response_model=WatchlistResponse, status_code=status.HTTP_200_OK)
@limiter.limit("30/minute")
